...
{
    public abstract class ngocyenWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ngocyenWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ngocyenWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ngocyenDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ngocyenDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ngocyenDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ngocyenDbContext, Task<T>> func)
        {
            T result;
